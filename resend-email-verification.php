...
<div class="login-container mt-5 mx-5">
       ...
       <div class="login-icon">
         ...
         <h3 style="color: #f6f7f6;">Resend Email Verification</h1>
         </div>
       
       <form action="resend-code.php" method="POST"> <!-- Replace "login.php" with your server-side script -->
           ...
           <div class="form-group">
              ...
              <button type="submit" class="btn btn-primary" name="resend_email_verify_btn">Verify</button>
