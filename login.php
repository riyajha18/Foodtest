...
<?php
        ...
        <div class="login-container mt-5 mx-5">
          ...
          <div class="login-icon">
            ...
            <h1 style="color: #f6f7f6;">Login Here</h1>
            </div>
          
          <form action="logincode.php" method="POST"> <!-- Replace "login.php" with your server-side script -->
              <div class="form-group mt-5">
                  <label for="email" class="infi" name="email">Email</label>
                  <input type="email" id="email" name="email" required>
              </div>
              <div class="form-group">
                  <label for="password" class="infi" name="rpassword">Password</label>
                  <input type="password" id="rpassword" name="rpassword" required>
              </div>
              <div class="form-group">
                <a href="index.php">
                    <center>
                 <button type="submit" class="btn btn-warning" name="logbutton">Submit</button></center>
                </a>
              </div>
              
              <p style="color: #ffffff;">Don't have an account? <a href="register.php">Sign up</a></p>
              <p style="display: inline;"><a href="password-reset.php">Forgot your password?</a></p>
